# Taken from https://github.com/lucidrains/denoising-diffusion-pytorch/blob/master/denoising_diffusion_pytorch/denoising_diffusion_pytorch.py
import math
import copy
import torch
...
class GaussianDiffusion(nn.Module):
    ...
    def sample(self, sample_batch_size = 16):
        ...
        return self.p_sample_loop((sample_batch_size, channels, image_size, image_size))
